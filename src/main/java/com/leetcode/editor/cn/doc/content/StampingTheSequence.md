...
<ul> 
 <li>For example, if <code>stamp = "abc"</code> and <code>target = "abcba"</code>, then <code>s</code> is <code>"?????"</code> initially. In one turn you can: </li>
</ul>
...
<div><div>Related Topics</div><div><li>栈</li><li>贪心</li><li>队列</li><li>字符串</li></div></div><br><div><li>👍 95</li><li>👎 0</li></div>